...
dataset.fillna({'reviewText': "", 'summary': ""}, inplace=True)
...
def Gram_Analysis(Corpus, Gram, N):
  stop_words_set = {'been', "don't", 're', 'under', 'should', 'ourselves', "wasn't", "doesn't", 'are', "mightn't",      
                  "wouldn't", 'by', 'yourself', 'any', 'why', "it's", 'between', 'which', 'who', 'ain', 'through',
                  'can', 'so', 'the', 'both', 'had', "hasn't", 'their', 'those', 'be', 'mustn', 'yourselves', 
                  "shan't", 'myself', 'it', 'ma', 'that', 'don', "won't", 'down', 'o', 'weren', 'then', 'how', 
                  'our', 'to', 'into', 'if', 'being', 'he', 'only', 'again', 'these', 'no', 'some', 'you', 'and', 
                  'over', 'is', 'here', 'each', 'there', 'were', 'wasn', "you'll", 'most', 'other', 'has', 'am', 
                  'd', 'on', 'mightn', "couldn't", "haven't", 'own', 'doing', 'too', 'herself', 'further', 'll', 
                  'what', 'she', 'same', 'my', 'your', "that'll", 'won', 'its', "you'd", 'needn', 'having', 'just', 
                  'off', 't', 'does', 'now', 'in', 'himself', 'while', 'wouldn', "she's", 'y', 'from', 'before', 
                  "hadn't", 'during', "shouldn't", 'yours', 'nor', 'an', 'couldn', 'we', 'with', 've', 'haven', 
                  "aren't", 'as', "mustn't", 'aren', 'all', 'hers', 'a', 'against', 'few', 'shouldn', 'once', 
                  'hadn', 'until', 'his', 'hasn', 'about', 'have', 'me', "you've", 'themselves', 'than', 'theirs', 
                  'them', 'was', 'they', 'or', 'did', 'such', "didn't", 's', "you're", 'because', 'out', 'up', 
                  "needn't", 'at', "should've", 'do', 'itself', 'ours', 'm', 'but', 'when', 'him', 'where', 
                  'isn', "weren't", 'her', 'will', 'i', 'didn', "isn't", 'shan', 'whom', 'for', 'doesn', 'above', 
                  'very', 'more', 'of', 'below', 'this', 'after'}
  # Vectorizer
  stop_words_list = list(stop_words_set)

  # Use stop_words_list in CountVectorizer
...
TF_IDF = TfidfVectorizer(max_features = 100000, ngram_range = (2, 2))
...
# LogReg = LogisticRegression(max_iter=100000, verbose=1)
# SVC = SVC()
RForest = RandomForestClassifier()
# Bayes = BernoulliNB()
# KNN = KNeighborsClassifier()
RForest.fit(X_train, y_train)  # Train your model
...
with open('tfidf_vectorizer.pkl', 'wb') as vectorizer_file:
    pickle.dump(TF_IDF, vectorizer_file)
...
# Classifier = LogisticRegression(max_iter=100000, verbose=1,random_state = 42, C = 6866.488450042998, penalty = 'l2')
...
"""
# Function to load the pre-trained TF-IDF vectorizer
def load_vectorizer():
...
# Make predictions using the loaded model and vectorizer
